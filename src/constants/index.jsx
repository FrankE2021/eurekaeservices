export const features = [
  {
    ...
    title: "Trabalhe de maneira mais inteligente e não mais difícil",
  ...
  },
  {
    ...
    title: "Durma tranquilo, nós protegemos você",
    text: "A segurança dos seus dados é a nossa prioridade. Com criptografia avançada e controles de privacidade robustos, o Eurekae ajuda a manter suas informações seguras e trancadas com mais segurança do que o Fort Knox.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "É fácil configurar o site?",
    answer:
      "Claro, com a nossa colaboração e comunicação próxima, podemos encontrar o resultado final certo, sempre seguindo os seus objetivos.",
  },
  {
    id: "1",
...
export const plans = [
  {
    ...
    priceMonthly: 69,
    priceYearly: 59,
    caption: "Melhor para criadores solo",
    features: [
      "Site inicial",
      "3 opções de revisão",
  ...
  },
  {
    ...
    priceMonthly: 149,
    priceYearly: 139,
    caption: "Melhor para negócios",
    features: [
      "Todos os recursos do padrão",
      "Até 10 páginas da web e um aplicativo",
      "Prioridade imediata e banco de dados",
